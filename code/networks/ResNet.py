...
def resnet(depth,num_classes,drop):
    if depth==18:
        return ResNet18(num_classes,drop)
    elif depth==34:
        return ResNet34(num_classes,drop)
    elif depth==50:
        return ResNet50(num_classes,drop)
    elif depth==101:
        return ResNet101(num_classes,drop)
    else:
        exit(-1)
